...
define view entity ZBM_I_ORDER
  as select from zbm_d_mrkt_order as Orrder
...

{
  ...
  key order_uuid     as OrderUuid,
      ...
      bus_part       as BusPartner,
      bus_part_name  as BusPartnerName,
      bus_part_group as BusPartnerGroup,
